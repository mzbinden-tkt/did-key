...
export const getDIDDocument = async (didId: string): Promise<{ document: DIDDocument }> => {
...
export const saveDIDDocument = async (document: DIDDocument): Promise<void> => {
...
export const saveKeyPair = async (publicKey: Uint8Array, privateKey: Uint8Array): Promise<void> => {
